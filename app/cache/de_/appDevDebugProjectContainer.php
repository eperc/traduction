...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserAdminBundle', ($this->targetDirs[2].'/Resources/UserAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserAdminBundle', ($this->targetDirs[3].'\\src\\User\\AdminBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserClientBundle', ($this->targetDirs[2].'/Resources/UserClientBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserClientBundle', ($this->targetDirs[3].'\\src\\User\\ClientBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserTranslatorBundle', ($this->targetDirs[2].'/Resources/UserTranslatorBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserTranslatorBundle', ($this->targetDirs[3].'\\src\\User\\TranslatorBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('certificate_file', $e, $a, $b));
        $f->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('certificate_file', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('certificate_file', $e, $a, $b));
        $f->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'traduction', 'user' => 'root', 'password' => 'jusedu', 'charset' => 'UTF8', 'driverOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7c39d0d7510a6c145c2dd53482211a83323698692f51981dc77cf5407744c0ae');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/translator/');
        ...
        $m->add($l, array(0 => 'ROLE_TRANSLATOR'), NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'UserAdminBundle', 1 => 'UserClientBundle', 2 => 'UserTranslatorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\ClientBundle/Resources/views'), 'UserClient');
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\TranslatorBundle/Resources/views'), 'UserTranslator');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dca922a9d4068bd6366af46b4be335afdd703529');
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('certificate_file' => array('uri_prefix' => '/documents/certificates', 'upload_destination' => '%kernel.root_dir/../web/documents/certificates', 'namer' => NULL, 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserClientBundle' => 'User\\ClientBundle\\UserClientBundle',
                'UserTranslatorBundle' => 'User\\TranslatorBundle\\UserTranslatorBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'traduction',
            'database_user' => 'root',
            'database_password' => 'jusedu',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'dca922a9d4068bd6366af46b4be335afdd703529',
            'locale' => 'en',
            ...
            'kernel.secret' => 'dca922a9d4068bd6366af46b4be335afdd703529',
            ...
            'vich_uploader.mappings' => array(
                'certificate_file' => array(
                    'uri_prefix' => '/documents/certificates',
                    'upload_destination' => '%kernel.root_dir/../web/documents/certificates',
                    'namer' => NULL,
