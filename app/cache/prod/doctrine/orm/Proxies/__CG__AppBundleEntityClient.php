...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'demands');
        }
    ...
    public function addDemand(\AppBundle\Entity\Demand $demand)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDemand', array($demand));

        return parent::addDemand($demand);
    }
